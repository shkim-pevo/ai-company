...
The active skill lives at `skills/browse/`. After making changes:

1. Push your branch
2. Pull the latest: `git pull`
3. Rebuild: `cd skills/browse && bun run build`

Or copy the binary directly: `cp browse/dist/browse skills/browse/browse/dist/browse`
