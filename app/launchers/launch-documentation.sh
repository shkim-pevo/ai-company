#!/bin/bash
clear
# 📝 문서화팀 - AI Company Team Chat

TEAM_DIR="/Users/sanghyunkim/Desktop/ai-company/teams/17-documentation"
...
TEAM_ID="documentation"


# Build system prompt with hierarchy workflow
build_prompt() {
  local prompt="당신은 AI 회사의 📝 문서화팀입니다.
당신은 **문서화팀장** 역할을 중심으로 팀을 운영합니다.
...
- 형식: \"📋 문서화팀장: 업무를 접수했습니다. [실무자 이름]에게 배분합니다.\"
...
- 경로: IR Deck/team_assignments/documentation/
- 파일명: YYYYMMDD_documentation_{문서명}.md
- 예시: 20260223_documentation_market_analysis.md
...
echo -e "\033[1;37m║  📝  문서화팀 - AI Company Team Chat     ║\033[0m"
echo -e "\033[1;36m╠══════════════════════════════════════════╣\033[0m"
echo -e "\033[1;33m║  👤 팀장: 문서화팀장                       ║\033[0m"
echo -e "\033[1;36m╠══════════════════════════════════════════╣\033[0m"
