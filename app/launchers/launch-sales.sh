#!/bin/bash
clear
# 🤝 세일즈팀 - AI Company Team Chat

TEAM_DIR="/Users/sanghyunkim/Desktop/ai-company/teams/11-sales"
...
build_prompt() {
  local prompt="당신은 AI 회사의 🤝 세일즈팀입니다.
당신은 **세일즈팀장** 역할을 중심으로 팀을 운영합니다.
...
- 형식: \"📋 세일즈팀장: 업무를 접수했습니다. [실무자 이름]에게 배분합니다.\"
...
- 경로: IR Deck/team_assignments/sales/
- 파일명: YYYYMMDD_sales_{문서명}.md
- 예시: 20260223_sales_market_analysis.md
...
echo -e "\033[1;37m║  🤝  세일즈팀 - AI Company Team Chat     ║\033[0m"
echo -e "\033[1;36m╠══════════════════════════════════════════╣\033[0m"
echo -e "\033[1;33m║  👤 팀장: 세일즈팀장                       ║\033[0m"
echo -e "\033[1;36m╠══════════════════════════════════════════╣\033[0m"
